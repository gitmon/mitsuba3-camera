...
Checkerlines texture (:monosp:`checkerlines`)
---------------------------------------------
...
.. subfigure:: ../../resources/data/docs/images/render/texture_checkerboard.jpg
   :caption: Checkerlines applied to the material test object as well as the ground plane.
.. subfigend::
...
class Checkerlines final : public Texture<Float, Spectrum> {
public:
    MI_IMPORT_TYPES(Texture)

    Checkerlines(const Properties &props) : Texture(props) {
...
MI_IMPLEMENT_CLASS_VARIANT(Checkerlines, Texture)
MI_EXPORT_PLUGIN(Checkerlines, "Checkerlines texture")
